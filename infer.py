...
def main():
    ...
    model = P2R_ZIP_Model(
        ...
        pi_thresh=pi_thresh_infer,
        gate=cfg["MODEL"]["GATE"],
        pi_mode=pi_mode_infer,
        pi_floor=pi_floor_infer,
        lambda_clamp=lambda_clamp_infer,
