"""
Gating visualization tool for the P2R-ZIP model.

Generates multi-panel visualizations comparing raw density, hard gating,
and soft fusion outputs. Shows ZIP confidence maps, patch classification
overlays, probability histograms, and log-density detail views. Supports
stage1/stage2/stage3 checkpoints with automatic scale compensation loading.
"""
import argparse
import os
import random
...
def visualize_sample(
    ...
    overlay_cls[mask_fg] = overlay_cls[mask_fg] * 0.7 + np.array([0, 255, 0]) * 0.3
    overlay_cls[~mask_fg] = overlay_cls[~mask_fg] * 0.7 + np.array([0, 0, 255]) * 0.3
