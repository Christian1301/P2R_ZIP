...
# -*- coding: utf-8 -*-
"""
Stage 2 - P2R (Point-to-Region) density head training with ZIP bypass features.

Architecture: Backbone (frozen) + ZIP Head (frozen) produce pi and lambda,
which are concatenated with backbone features (512+2=514 channels) as input
to the trainable P2R head. Includes aggressive data augmentation, sliding
window validation for large images, and mixed-precision training support.
"""
